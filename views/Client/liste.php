                ...
                <tr>
                    ...
                    <?php if ($_SESSION["user"]["role"] == "gestionnaire") : ?>
                        <td class="w-1/6 py-3 px-4">
                            <a href="<?= webRoot ?>/?controller=Vente&action=edit&id=<?php echo $client['id']; ?>" class="bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-700">Modifier</a>
                            <a href="<?= webRoot ?>/?controller=Vente&action=delete&id=<?php echo $client['id']; ?>" class="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-700 ml-2">Supprimer</a>
                        </td>
                    <?php endif; ?>
                </tr>
            <?php endforeach; ?>
